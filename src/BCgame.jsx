  ...
  const differentialTables = [
    ...
    },
    {
      ...
      rolls: [
        ...
        { range: [2, 11], output: 'Loss Chart B' },
        { range: [12, 20], output: 'Loss Chart C' },
        { range: [21, 28], output: 'Loss Chart D' },
        { range: [29, 33], output: 'Loss Chart E' },
        { range: [34, 41], output: 'Loss Chart F' },
        { range: [42, 49], output: 'Loss Chart G' },
        { range: [50, 54], output: 'Loss Chart H' },
        { range: [55, 55], output: 'Loss Chart I' },
        { range: [56, 56], output: 'Win Chart I' },
        { range: [57, 61], output: 'Win Chart H' },
        { range: [62, 73], output: 'Win Chart G' },
        { range: [74, 87], output: 'Win Chart F' },
        { range: [88, 97], output: 'Win Chart E' },
    ...
    }, 
    {
      ...
      max: 364,
      rolls: [
        { range: [1, 3], output: 'Loss Chart B' },
        { range: [4, 5], output: 'Loss Chart C' },
        { range: [6, 10], output: 'Loss Chart D' },
        { range: [11, 13], output: 'Loss Chart E' },
        { range: [14, 23], output: 'Loss Chart F' },
        { range: [24, 39], output: 'Loss Chart G' },
        { range: [40, 42], output: 'Loss Chart H' },
        { range: [43, 43], output: 'Loss Chart I' },
        { range: [44, 44], output: 'Win Chart I' },
        { range: [45, 51], output: 'Win Chart H' },
        { range: [52, 58], output: 'Win Chart G' },
        { range: [58, 81], output: 'Win Chart F' },
        { range: [82, 87], output: 'Win Chart E' },
        { range: [88, 96], output: 'Win Chart D' },
        { range: [97, 98], output: 'Win Chart C' },
        { range: [99, 99], output: 'Win Chart B' },
         { range: [100, 100], output: 'Win Chart A' },
      ],
    }, 
